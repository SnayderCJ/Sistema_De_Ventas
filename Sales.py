...
class Sale(ICalculos):
    ...
    def __init__(self, client):
        Sale.next_id += 1
        self.__invoice = f"F0{Sale.next_id}"
    ...
    def getJson(self):
        return {"Invoice":self.invoice, "Date":str(self.date), "Client":self.client.getJson(), "Subtotal":self.subtotal, "Discount":self.discount, "Iva":self.iva, "Total":self.total}
